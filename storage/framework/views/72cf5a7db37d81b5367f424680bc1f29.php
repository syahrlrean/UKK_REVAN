                ...
                <div class="card card-pro card-grad-yellow p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold text-white mt-2 mb-0" style="font-size: 1.5rem;">
                                <?php echo e(number_format($ringkasan['total_transaksi'])); ?> <span class="fs-6 fw-normal" style="color: #fef08a;">trx</span>
                            </h3>
                        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4">
                                ...
                                <?php else: ?>
                                    <span class="fw-bold ps-2" style="color: #a1a1aa;"><?php echo e($index + 1); ?></span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center font-monospace" style="color: #fef08a;"><?php echo e($produk->stok); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POS-main\resources\views/dashboard.blade.php ENDPATH**/ ?>