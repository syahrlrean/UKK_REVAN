<?php $__env->startSection('title', 'Kasir Transaksi'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div
            ...
            <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-back-custom d-inline-flex align-items-center gap-2">
                <i class="bi bi-arrow-left"></i> Kembali ke Riwayat
            </a>
        </div>

        <form action="<?php echo e(route('penjualan.store')); ?>" method="POST" id="formTransaksi">
            <?php echo csrf_field(); ?>
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row g-3" id="productGrid">
                        <?php $__empty_1 = true; $__currentLoopData = $produks ?? $produk ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-12 col-sm-6 col-md-4 product-item"
                                data-nama="<?php echo e(strtolower($item->nama ?? $item->nama_produk)); ?>">
                                <div class="product-card">
                                    <div>
                                        <div class="product-img-box">
                                            <?php if(!empty($item->foto)): ?>
                                                <img src="<?php echo e(asset('storage/' . $item->foto)); ?>"
                                                    alt="<?php echo e($item->nama ?? $item->nama_produk); ?>">
                                            <?php else: ?>
                                                <i class="bi bi-box-seam fs-2 text-muted opacity-50"></i>
                                            <?php endif; ?>
                                        </div>
                                        <h6 class="fw-bold text-white mb-1 text-truncate"
                                            title="<?php echo e($item->nama ?? $item->nama_produk); ?>">
                                            <?php echo e($item->nama ?? $item->nama_produk); ?>

                                        </h6>
                                        <p class="text-muted small mb-2">Stok: <strong
                                                class="text-white"><?php echo e($item->stok); ?></strong></p>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <button type="button" class="btn btn-add-cart"
                                            onclick="addToCart(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nama ?? $item->nama_produk)); ?>', <?php echo e($item->harga_jual); ?>, <?php echo e($item->stok); ?>)">
