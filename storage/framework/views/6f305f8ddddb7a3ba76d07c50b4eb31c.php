...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center pb-4 mb-4 border-bottom border-secondary border-opacity-25">
        ...
        <div class="mt-3 mt-md-0">
            <?php if(Route::has('admin.users.create')): ?>
            <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-yellow px-3 py-2 rounded-3 d-inline-flex align-items-center gap-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="fw-semibold text-white"><?php echo e($user->name); ?></span>
                            </div>
                        </td>
                        <td class="text-muted font-monospace small"><?php echo e($user->email); ?></td>
                        <td class="text-center">
                            <?php if(optional($user->role)->name == 'admin' || $user->role == 'admin'): ?>
                        ...
                        <td class="text-end pe-4">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="btn btn-sm btn-outline-warning d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </a>
                                <?php endif; ?>

                                <?php if(Route::has('admin.users.destroy')): ?>
                                <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus user ini?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POS-main\resources\views/users/index.blade.php ENDPATH**/ ?>